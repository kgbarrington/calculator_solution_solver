...
/*
*   Summary:    This function converts a double to a string with a precision of 4.
*
...
/*
*   Summary:    This function removed the last character of a string. It is used to
...
*
*   Return:     double of the converted string.
*/
